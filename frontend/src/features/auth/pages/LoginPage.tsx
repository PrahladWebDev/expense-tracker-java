  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-950 px-4">
      <div className="w-full max-w-sm bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 p-8">
        <h1 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-1">{t('auth.welcomeBack')}</h1>
        <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">{t('auth.signInSubtitle')}</p>
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-6 text-center">
          {t('auth.noAccount')}{' '}
          <Link to="/register" className="text-brand-600 dark:text-brand-100 font-medium hover:underline">
            {t('auth.registerLink')}
          </Link>
        </p>
      </div>
